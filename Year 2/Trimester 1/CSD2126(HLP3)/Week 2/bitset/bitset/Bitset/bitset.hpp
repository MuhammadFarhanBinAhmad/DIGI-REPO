/*****************************************************************//**
 * \file	bitset.hpp
 * \brief	Implement a clone of class bitset using bit operators
 *
...
// 0 - FALSE
// 1 - TRUE
//NOTE TO FUTURE SELF:Week break/Tri break go revise more on bitshift.
//Powerful tool to use in future but you weak at it. Go redo this ass but with a twist(like that temp link list ass but you make it a double link list instead) 
namespace HLP3
{
    /*!

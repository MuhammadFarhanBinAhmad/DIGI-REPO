// HLP3: quiz+nvi.cpp
// 11/05/2023
// Use the NVI and TMP implemented in IQuestion hierarchy which is
// implemented in question+nvi.h
#include <iostream>
#include <string>
#include <list>
#include <vector>
#include "question+nvi.h"
...
public:
  ...
  Quiz(std::vector<IQuestion*> const&);
  Quiz(Quiz const& rhs);
  ~Quiz() = default;
...
extern std::vector<IQuestion*> make_quiz();
